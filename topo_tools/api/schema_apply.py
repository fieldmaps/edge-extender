...
from topo_tools.core.schema_apply import _01_inputs as inputs
from topo_tools.core.schema_apply import _02_rename as rename_stage
from topo_tools.core.schema_apply import _03_outputs as outputs
...
def schema_apply(  # noqa: PLR0913
    ...
    *,
    ...
    """Rename/drop columns per a crosswalk (from schema_propose, possibly edited).
    ...
    name = input_basename(input_path).replace(".", "_") + "_schema_apply"
