...
from topo_tools.core.refactor import _01_inputs as inputs
from topo_tools.core.refactor import _02_rename as rename_stage
from topo_tools.core.refactor import _03_outputs as outputs
...
def refactor(  # noqa: PLR0913
    ...
    *,
    ...
    name = input_basename(input_path).replace(".", "_") + "_refactor"
