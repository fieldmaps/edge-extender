...
from topo_tools.core.topo_detect import _01_inputs as inputs
from topo_tools.core.topo_detect import _02_issues as issues
from topo_tools.core.topo_detect import _03_outputs as outputs
...
def detect(  # noqa: PLR0913
    ...
    *,
    ...
    # "_topo_detect" keeps every table/file this call creates distinct from
    # another tool's run against the same input_path/tmp_dir.
    name = input_basename(input_path).replace(".", "_") + "_topo_detect"
