...
`docs/reference/shared.md` for rules `edge-extend` shares with other tools.
...
- `edge-extend`'s final output MUST pass the hard gate in `docs/reference/shared.md` (no
