...
```python
from topo_tools import edge_extend

edge_extend("example.geojson", "example_extended.geojson")
```
...
Run `topo-tools edge-extend --help` for the full, always-current option list.

## How it Works

`edge-extend` applies the Voronoi algorithm along polygon edges, giving results similar
...
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_01.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_02.png) |
...
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_03.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_04.png) |
...
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_05.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_06.png) |
...
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_09.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tza_10.png) |
...
| :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tri_00.png) |

|                                Original boundaries                                 |                             Clipped voronoi boundaries                             |
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tri_01.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tri_02.png) |

|                          Original boundaries (tri-point)                           |                       Clipped voronoi boundaries (tri-point)                       |
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tri_03.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/tri_04.png) |
...
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/wld_01.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/wld_02.png) |

|                                   Original ADM0                                    |                            Coastline replaced with OSM                             |
| :--------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/wld_03.png) | ![](https://raw.githubusercontent.com/OCHA-DAP/topo-tools-py/main/img/wld_04.png) |
